...
class Student:public User{
    ...
    public:
        ...
        string renewalDate):User(id, uname,password, fullName, DateOfBirth, userType, gender){  
            ...
            for (auto row: this->accountList){
                if (row[0] == id){
                    ...
                    if (userType == "0"){
                        ...
                        Student* student = new Student(id, uname, password, fullName, dob, userType, gender,studentID, renewalDate);
                        return student;
                    }
                    else if (userType == "1"){
